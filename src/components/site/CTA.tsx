    ...
    <section className="relative overflow-hidden">
      <div className="container-prose">
        <div className="relative rounded-3xl bg-teal-gradient text-white p-10 md:p-16 overflow-hidden shadow-elegant">
          <div
            className="absolute -top-24 -right-16 w-80 h-80 rounded-full bg-[color:var(--gold)]/30 blur-3xl glow"
            aria-hidden
          />
          <div
            className="absolute -bottom-24 -left-16 w-80 h-80 rounded-full bg-white/10 blur-3xl"
            aria-hidden
          />
          <div className="relative max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <CTAButton to={ROUTES.programs} variant="ghost">
                Explore Programs
              </CTAButton>
            </div>
          </div>
